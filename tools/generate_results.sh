...
# Localization corrections
rosrun robot_localization_tools probability_distribution_plotter.py -i ${results_directory}/results__dynamic_robot_localization_localization_detailed.csv -o ${results_directory}/translation_correction_millimeters_distributions -c 50 -t 'Probability distributions for translation correction (millimeters)' -x 'Translation correction histogram bins (millimeters)' ${probability_distributions_common_configs} >> ${probability_distributions_csv} &
rosrun robot_localization_tools probability_distribution_plotter.py -i ${results_directory}/results__dynamic_robot_localization_localization_detailed.csv -o ${results_directory}/rotation_correction_degrees_distributions -c 54 -t 'Probability distributions for rotation correction (degrees)' -x 'Rotation correction histogram bins (degrees)' ${probability_distributions_common_configs} >> ${probability_distributions_csv} &

# Registration analysis
rosrun robot_localization_tools probability_distribution_plotter.py -i ${results_directory}/results__dynamic_robot_localization_localization_detailed.csv -o ${results_directory}/outlier_percentage_distributions -c 55 -t 'Probability distributions for outlier percentage [0..1]' -x 'Outlier percentage histogram bins [0..1]' ${probability_distributions_common_configs} >> ${probability_distributions_csv} &
rosrun robot_localization_tools probability_distribution_plotter.py -i ${results_directory}/results__dynamic_robot_localization_localization_detailed.csv -o ${results_directory}/root_mean_square_error_inliers_distributions -c 56 -t 'Probability distributions for inliers root mean square error (millimeters)' -x 'Root mean square error histogram bins (millimeters)' ${probability_distributions_common_configs} >> ${probability_distributions_csv} &
rosrun robot_localization_tools probability_distribution_plotter.py -i ${results_directory}/results__dynamic_robot_localization_localization_detailed.csv -o ${results_directory}/registered_points_angular_distribution_inliers_distributions -c 59 -t 'Probability distributions for inliers angular distribution [0..1]' -x 'Inliers angular distribution histogram bins [0..1]' ${probability_distributions_common_configs} >> ${probability_distributions_csv} &
rosrun robot_localization_tools probability_distribution_plotter.py -i ${results_directory}/results__dynamic_robot_localization_localization_detailed.csv -o ${results_directory}/registered_points_angular_distribution_outliers_distributions -c 60 -t 'Probability distributions for outliers angular distribution [0..1]' -x 'Outliers angular distribution histogram bins [0..1]' ${probability_distributions_common_configs} >> ${probability_distributions_csv} &
